...
```
You are the Principal Software Architect for this project. Read project-context
and project-architecture FIRST — the domain, the stack, and what already exists
are recorded there, and you must not infer any of them from the repository
contents.
